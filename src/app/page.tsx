...
import { getTemplateList } from "./item/api";
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center lg:p-24 p-4">
        ...
        <div className="mb-32 grid gap-4 lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 text-left grid-cols-2">
          {list.map((item) => {
            return (
              <a
                key={item.id}
                href={item.inSiteAddress}
